...
const BusinessmanHome: React.FC = () => {
  ...
  const navigateToInventory = () => {
    history.push('/Businessman_inventory');
  };

  const navigateToBilling = () => {
    history.push('/Businessman_billing');
  };

  const navigateToAccount = () => {
    history.push('/Businessman_account');
  };
    ...
    <IonPage>
      ...
      <IonContent style={contentStyle}>
        ...
        <div style={{
          ...
          <div style={{
            background: 'linear-gradient(135deg, #2E8B5720 0%, #228B2210 100%)',
            borderRadius: '12px',
            padding: '16px',
            ...
            <p style={{ 
              ...
              💼 Pro Tip: Keep your inventory organized and billing system updated. 
              Efficient operations lead to happy customers and higher profits!
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          border: '1px solid rgba(255,255,255,0.4)',
          boxShadow: '0 6px 24px rgba(0,0,0,0.08)',
          transform: animateContent ? 'scale(1)' : 'scale(0.95)',
          opacity: animateContent ? 1 : 0,
